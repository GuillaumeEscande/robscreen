...
from robscreen.pages.homes.start import Start
...
class Home(Page):
    ...
    def __init__(self):
        Page.__init__(self, Annuaire.PAGE_HOME)
        Start()
    ...
    def draw(self, draw):
        ...
        draw.text(((constants.WIDTH - 4*14)/2, constants.HEIGHT - 20),    'Home',  font=self.fontb20, fill=255)


    def k1(self):
        return Annuaire.PAGE_WIFI
    def k2(self):
        return Annuaire.PAGE_HOMES_START
    def k3(self):
